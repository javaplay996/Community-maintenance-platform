...
public class ZhuhuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZhuhuEntity user = zhuhuService.selectOne(new EntityWrapper<ZhuhuEntity>().eq("yonghuming", username));
    ...
    public R register(@RequestBody ZhuhuEntity zhuhu){
    	...
    	ZhuhuEntity user = zhuhuService.selectOne(new EntityWrapper<ZhuhuEntity>().eq("yonghuming", zhuhu.getYonghuming()));
		if(user!=null) {
