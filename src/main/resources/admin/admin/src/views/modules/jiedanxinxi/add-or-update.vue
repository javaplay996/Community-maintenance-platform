      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="维修类型" prop="weixiuleixing">
          <el-input v-model="ruleForm.weixiuleixing" 
              placeholder="维修类型" clearable  :readonly="ro.weixiuleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="维修类型" prop="weixiuleixing">
              <el-input v-model="ruleForm.weixiuleixing" 
          ...
          <el-form-item class="input" label="住户姓名" prop="zhuhuxingming">
              <el-input v-model="ruleForm.zhuhuxingming" 
                placeholder="住户姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="接单内容" prop="jiedanneirong">
          <el-input v-model="ruleForm.jiedanneirong" 
              placeholder="接单内容" clearable  :readonly="ro.jiedanneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="接单内容" prop="jiedanneirong">
              <el-input v-model="ruleForm.jiedanneirong" 
                placeholder="接单内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="接单日期" prop="jiedanriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jiedanriqi" 
                type="date"
                placeholder="接单日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jiedanriqi" label="接单日期" prop="jiedanriqi">
              <el-input v-model="ruleForm.jiedanriqi" 
                placeholder="接单日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhuhuxingming = true;
            continue;
	            	            ...
	            	            if(o=='jiedanneirong'){
            this.ruleForm.jiedanneirong = obj[o];
	    this.ro.jiedanneirong = true;
            continue;
          }
	            	            if(o=='jiedanriqi'){
            this.ruleForm.jiedanriqi = obj[o];
	    this.ro.jiedanriqi = true;
            continue;
          }
	            	            if(o=='zhanghao'){
