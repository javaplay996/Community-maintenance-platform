          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="举报内容" prop="jubaoneirong">
          <el-input v-model="ruleForm.jubaoneirong" 
              placeholder="举报内容" clearable  :readonly="ro.jubaoneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="举报内容" prop="jubaoneirong">
              <el-input v-model="ruleForm.jubaoneirong" 
                placeholder="举报内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
