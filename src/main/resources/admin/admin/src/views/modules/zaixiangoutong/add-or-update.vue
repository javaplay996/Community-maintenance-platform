          ...
          <el-form-item class="input" label="住户姓名" prop="zhuhuxingming">
              <el-input v-model="ruleForm.zhuhuxingming" 
                placeholder="住户姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="聊天内容" prop="liaotianneirong">
          <el-input v-model="ruleForm.liaotianneirong" 
              placeholder="聊天内容" clearable  :readonly="ro.liaotianneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="聊天内容" prop="liaotianneirong">
              <el-input v-model="ruleForm.liaotianneirong" 
                placeholder="聊天内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
